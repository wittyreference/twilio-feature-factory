...
| Verification reference (code samples, testing) | [functions/verify/REFERENCE.md](/functions/verify/REFERENCE.md) |
| State synchronization | [functions/sync/CLAUDE.md](/functions/sync/CLAUDE.md) |
| Sync reference (API examples, patterns) | [functions/sync/REFERENCE.md](/functions/sync/REFERENCE.md) |
| Task routing | [functions/taskrouter/CLAUDE.md](/functions/taskrouter/CLAUDE.md) |
| TaskRouter reference (API, workflows, patterns) | [functions/taskrouter/REFERENCE.md](/functions/taskrouter/REFERENCE.md) |
| Messaging services | [functions/messaging-services/CLAUDE.md](/functions/messaging-services/CLAUDE.md) |
| Messaging services reference (API, compliance, errors) | [functions/messaging-services/REFERENCE.md](/functions/messaging-services/REFERENCE.md) |
...
| Doc generator reference (extractors, types, usage) | [agents/doc-generator/REFERENCE.md](/agents/doc-generator/REFERENCE.md) |
| Setup scripts | [scripts/CLAUDE.md](/scripts/CLAUDE.md) |
| Scripts reference (per-script docs, usage, troubleshooting) | [scripts/REFERENCE.md](/scripts/REFERENCE.md) |
