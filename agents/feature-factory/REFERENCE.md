// ABOUTME: Reference documentation for Feature Factory architecture, autonomous modes, and detailed workflows.
// ABOUTME: Contains workflow phase details, implementation patterns, configuration options, and validation schemas.

# Feature Factory Reference

Comprehensive documentation for Feature Factory internals, workflow execution, and configuration.

## Table of Contents

1. [Workflow Phases](#workflow-phases)
2. [Autonomous Mode](#autonomous-mode)
3. [Sandbox Mode](#sandbox-mode)
4. [Context Window Management](#context-window-management)
5. [Phase Output Validation](#phase-output-validation)
6. [Phase Retry Strategy](#phase-retry-strategy)
7. [Git Checkpoints](#git-checkpoints)
8. [Autonomous Worker](#autonomous-worker)
9. [Process Validation Infrastructure](#process-validation-infrastructure)
...
The Feature Factory uses the Twilio MCP server for:
