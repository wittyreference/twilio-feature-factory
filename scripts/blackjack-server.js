#!/usr/bin/env node
// ABOUTME: Local Express server for the blackjack demo browser client.
// ABOUTME: Serves the HTML client, Voice SDK bundle, and generates access tokens.
...
const PORT = process.env.BLACKJACK_PORT || 3335;
const app = express();
...
app.get('/api/token', (req, res) => {
  ...
  const identity = req.query.identity || `blackjack-player-${Date.now()}`;
